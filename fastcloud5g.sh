...
makeConfig() {
	...
	echo "---------------"
	read -p "Link website: https://fastcloud5g.com/"
	echo "---------------"
	read -p "API key của web: admin@fastcloud5g.com"
	echo "---------------"
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/ssl-fastcloud5g/crt.crt 
        KeyFile: /etc/XrayR/ssl-fastcloud5g/key.key
        Provider: alidns 
        Email: test@me.com
        DNSEnv: 
...
EOF
	cd /etc/XrayR
	git clone https://github.com/chaomynhan/ssl-fastcloud5g.git
	XrayR restart
