...
pre_install_docker_compose() {
  echo -e "  [1] vpngiare.net"
  echo -e "  [2] vpngiare.net"
  read -p "  Web đang sử dụng:" api_host
  if [ "$api_host" == "1" ]; then
    api_host="https://vpngiare.net/"
  elif [ "$api_host" == "2" ]; then
    api_host="https://vpngiare.net/"
  else 
    api_host="https://https://vpngiare.net/"
  fi
...
clear
while true; do
  echo "  Vui lòng nhập một số để Thực Hiện Câu Lệnh:Nmquan admin shop vpngiare.net"
