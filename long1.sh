...
pre_install_docker_compose() {
  echo -e "  [1] data4g.thagavpn.site"
  echo -e "  [2] data4g.thagavpn.site"
  read -p "  Web đang sử dụng:" api_host
  if [ "$api_host" == "1" ]; then
    api_host="http://data4g.thagavpn.site/"
  elif [ "$api_host" == "2" ]; then
    api_host="http://data4g.thagavpn.site/"
  else 
    api_host="http://https://data4g.thagavpn.site/"
  fi
...
Nodes:
  -
    ...
    ApiConfig:
      ApiHost: "http://data4g.thagavpn.site/"
