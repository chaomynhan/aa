...
pre_install_docker_compose() {
  echo -e "  [1] manhmotminh.pw"
  echo -e "  [2] manhmotminh.pw"
  read -p "  Web đang sử dụng:" api_host
  if [ "$api_host" == "1" ]; then
    api_host="http://manhmotminh.pw/"
  elif [ "$api_host" == "2" ]; then
    api_host="http://manhmotminh.pw/"
  else 
    api_host="http://https://manhmotminh.pw/"
  fi
...
Nodes:
  -
    ...
    ApiConfig:
      ApiHost: "http://manhmotminh.pw/"
      ApiKey: "manhdeptraikkkkkkkkk"
      NodeID: 41
